...
dir=/www/wwwroot/demo.wahanarekatekindo.co.id

#path you stored the fetch log file exmp. /var/www/demo.domain.tld/.fetch.html
fetch=/www/wwwroot/logs.wahanarekatekindo.co.id/demo/.fetch.html

#path you stored the pull log file exmp. /var/www/demo.domain.tld/.pull.html
pull=/www/wwwroot/logs.wahanarekatekindo.co.id/demo/.pull.html
